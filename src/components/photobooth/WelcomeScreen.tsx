  ...
  return (
    <div className="relative flex flex-col items-center justify-center min-h-screen px-8 overflow-hidden">
      ...
      <div className="relative flex flex-col items-center gap-10 animate-float-in z-10">
        ...
        <button
          onClick={handleStart}
          className="group relative mt-2 animate-glow-pulse rounded-full bg-primary text-primary-foreground px-14 py-7 font-display text-3xl font-semibold tracking-wide active:scale-95 transition-transform duration-200 flex items-center gap-3"
        >
          <Camera size={28} />
          Démarrer
        </button>

        <p className="text-sm text-muted-foreground/70 font-body animate-gentle-pulse">
